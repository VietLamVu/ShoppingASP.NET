...
namespace Shopping_Tutorial.Controllers
{
	public class HomeController : Controller
	{
		...
		public async Task<IActionResult> AddWishlist(long Id) 
		{
			...
			{
				return StatusCode(500, "Có lỗi trong khi thêm yêu thích");
			}
        ...
        public async Task<IActionResult> Compare()
        {
            var compare_product = await (from c in _dataContext.Compares
                                         ...
                                         select Tuple.Create(u, p, c)) // Tạo Tuple với 3 phần tử: User, Product, Compare
                                        .ToListAsync();
		...
		public async Task<IActionResult> AddCompare(long Id)
		{
			...
			{
				return StatusCode(500, "Có lỗi trong khi thêm so sánh");
			}
